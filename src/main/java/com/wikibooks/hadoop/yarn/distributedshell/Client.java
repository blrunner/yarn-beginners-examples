...
package com.wikibooks.hadoop.yarn.distributedshell;
...
public class Client {
  ...
  public Client(Configuration conf) throws Exception  {
    this(
        "com.wikibooks.hadoop.yarn.distributedshell.ApplicationMaster",
        conf);
  }
  ...
  Client(String appMasterMainClass, Configuration conf) {
    ...
    opts = new Options();
    opts.addOption("appname", true, "Application Name. Default value - WikibooksDistributedShell");
  ...
  public boolean init(String[] args) throws ParseException {
    ...
    appName = cliParser.getOptionValue("appname", "WikibooksDistributedShell");
